...
#ifndef ELF_MACHINE
#  error "ELF_MACHINE must be defined (e.g. EM_AARCH64, EM_RISCV, EM_LOONGARCH)"
#endif
...
int main(int argc, char *argv[])
{
	...
	if (!host_is_little_endian()) {
		fprintf(stderr, "error: big-endian host not supported\n");
		return ret;
	}
	...
	pad_after_cmdline = 0;
	/* string table section has no alignment requirement */
