...
/*
 * Ensure the four sections that bpftool/libbpf expect always exist,
 * regardless of compiler version or optimization flags.
 */
static const char dummy_rodata[16] __attribute__((used, section(".rodata")))
	= "rodata";

static char dummy_data[16] __attribute__((used, section(".data")))
	= "data";

static const char dummy_rodata_str1_1[] __attribute__((used, section(".rodata.str1.1")))
	= "str1.1";

static char dummy_bss __attribute__((used, section(".bss")));
#endif
